...
class Showsubcategory extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $category = $this->_registrydata->registry('current_category'); //Get Current Category
        $cate = $this->_categorydata->load($category->getID());
        $slider = $cate->getData("Subcategoriessliderslider");
        return $slider;
    }
    ...
    public function getListvalue()
    {
        $category = $this->_registrydata->registry('current_category'); //Get Current Category
        $cate = $this->_categorydata->load($category->getID());
        $list = $cate->getData("Subcategoriessliderlist");
        return $list;
    }
