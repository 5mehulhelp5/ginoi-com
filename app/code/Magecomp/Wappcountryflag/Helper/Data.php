...
{
    const ENABLED = 'whatsapppro/wappcountryflag/enable';
    const DETECT_BY_IP = 'whatsapppro/wappcountryflag/detect_by_ip';
    const DETECT_BY_DEFAULT_COUNTRY = 'whatsapppro/wappcountryflag/defaultcountry';
    const COUNTRY_CODE_PATH = 'general/country/default';
    const COUNTRY_VALIDATION = 'whatsapppro/wappcountryflag/countryvalidate';
    ...
    {
        $digit='';
        $validation = $this->scopeConfig->getValue(self::COUNTRY_VALIDATION, ScopeInterface::SCOPE_STORE, $this->getStoreid());
