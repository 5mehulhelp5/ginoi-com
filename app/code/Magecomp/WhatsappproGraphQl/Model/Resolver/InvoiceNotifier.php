    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        try {
            if (empty($args['invoiceId'])) {
              ...
              $responce=$this->WhatsappproInterface->sendInvoiceNotification($args['invoiceId']);
            ...
            throw new GraphQlNoSuchEntityException(__("Requested Invoice is not found."));
