    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        try {
            if (empty($args['shipmentId'])) {
             ...
             $responce=$this->WhatsappproInterface->sendShipmentNotification($args['shipmentId']);
            return json_decode($responce);
        } catch (NoSuchEntityException $exception) {
            throw new GraphQlNoSuchEntityException(__("Requested Shipment is not found."));
