...
class Datepicker extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $value = htmlspecialchars(is_null($row->getData($this->getColumn()->getIndex())) ? '' : $row->getData($this->getColumn()->getIndex()) ?? '');//$this->getProduct()->getPreconfiguredValues()->getData('options/' . $option->getId() . '/date');
