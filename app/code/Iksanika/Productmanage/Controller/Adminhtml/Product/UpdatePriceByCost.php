...
class UpdatePriceByCost extends \Magento\Catalog\Controller\Adminhtml\Product
{
    /**
        ...
        foreach ($productIds as $itemId => $productId)
        {
            try {
                ...
                if ($productId) {
                    ...
                    $product->setData('price', $this->_helperData->recalculatePrice($product->getData('cost'), $columnValuesForUpdate))->save();
...
//            $this->_productPriceIndexerProcessor->reindexList($productIds);
    ...
    {
        return $this->_authorization->isAllowed('Iksanika_Productmanage::ma_update_price_on_cost');
    }
