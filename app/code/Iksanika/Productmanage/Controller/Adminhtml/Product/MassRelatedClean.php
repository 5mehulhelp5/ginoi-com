...
class MassRelatedClean extends \Magento\Catalog\Controller\Adminhtml\Product
{
    ...
    public function execute()
    {
        ...
        if(is_array($productIds))
        {
            ...
            $this->messageManager->addSuccessMessage(__('Total of %1 out of %2 product(s) were successfully cleaned from related product(s).', $isUpdated, count($productIds)));
        }else
        {
    ...
    {
        return $this->_authorization->isAllowed('Iksanika_Productmanage::ma_related_to_clear');
    }
}
