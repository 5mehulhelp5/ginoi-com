...
class UpdateSpecialPriceByCost extends \Magento\Catalog\Controller\Adminhtml\Product
{
    /**
    ...
    public function execute()
    {
        ...
        foreach ($productIds as $itemId => $productId)
        {
            try {
                ...
                $product->setData('special_price', $this->_helperData->recalculatePrice($product->getData('cost'), $columnValuesForUpdate))->save();
...
//            $this->_productPriceIndexerProcessor->reindexList($productIds);
    ...
    {
        return $this->_authorization->isAllowed('Iksanika_Productmanage::ma_update_special_price_on_cost');
    }
